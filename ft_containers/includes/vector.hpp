...
namespace ft
{
  ...
  public:
    ...
    T *data(void) throw() { return reinterpret_cast<T *>(_begin); }
    const T *data(void) const throw() { return reinterpret_cast<const T *>(_begin); }
    ...
    size_type capacity(void) const { return static_cast<size_type>(_end_cap - _begin); }
